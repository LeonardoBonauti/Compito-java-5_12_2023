...
public class Tester {
    public static void main(String[] args) {
        ...
        System.out.println("Inserire punto (per verificare se compreso dentro cerchio 1):");
        ...
        System.out.println("il punto è compreso nel cerchio: " + circles[1].isInside(testPoint));
